...
from tfm_image_processor import ImageNetPreprocessor, CIFAR10Preprocessor
...
class ImagenetData(Dataset):
    ...
    def __init__(self, subset, data_dir='/home/dataset/ILSVRC2015_TFRecords'):
...
class CIFAR10Data(Dataset):
    def __init__(self, subset, data_dir='/home/dataset/cifar10_tfrecords'):
